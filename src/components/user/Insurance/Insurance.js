                      ...
                      <div className="form-group col-md-6">
                        <div className="col-sm-6 has-feedback">
                          ...
                          {/* <input
                            ...
                            disabled
                          /> */}
                          <input class="form-control" value={(number && number) || ""} disabled></input>
                        </div>
                        <div className="col-sm-6">
                          ...
                          <input class="form-control" value={status_list.find(x => x.id === status)?.name} disabled></input>
                        </div>
                        <div className="col-sm-12">
                          ...
                          />
                          <div className="help-block with-errors"></div> */}
                          <input class="form-control" value={representative_list.find(x => x.id === representative)?.name} disabled></input>
                        </div>
                        <div className="col-sm-6">
                          ...
                          />
                          <div className="help-block with-errors"></div> */}
                          <input class="form-control" value={(health_insurance && health_insurance) || ""} disabled></input>
                        </div>
                        <div className="col-sm-6">
                          ...
                          />
                          <div className="help-block with-errors"></div> */}
                          <input class="form-control" value={provinces_list.find(x => x.id === province)?.name} disabled></input>
                        </div>
                        <div className="col-sm-12">
                          <label className="control-label">
                            ĐK khám chữa bệnh
                          ...
                          {/* <input
                            ...
                            disabled
                          /> */}
                          <input class="form-control" value={(place && place) || ""} disabled></input>
                          <div className="help-block with-errors"></div>
                        </div>
                      </div>
                    </form>
