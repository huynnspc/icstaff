...
class Editors extends Component {
  ...
  onInputChange = (e) => {
    console.log('validator.isLength: ',validator.isLength(e.target.value,{min:0, max: 76}));
    if(!validator.isLength(e.target.value,{min:0, max: 76})){
      this.setState({
        error: "Tiêu đề không dài quá 76 kí tự!"
      })
    }
    this.setState({
          ...
          <form onSubmit={this.onSave}>
            <div className={
              ...
              <input 
                ...
                required
              />  
                <div className="errorMessage text-danger m-t-5 m-b-5" style={{fontSize: "smaller"}}>
